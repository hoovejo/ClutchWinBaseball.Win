...
{
    public class PlayersPitchersViewModel : INotifyPropertyChanged
    {
        private string _firstLetter, _lineOne, _lineTwo, _pitcherId;
        ...
        {
            get { return _pitcherId; }
            set { if (value != _pitcherId) { _pitcherId = value; NotifyPropertyChanged("PitcherId"); } }
        }
