...
{
    public sealed partial class TeamsOpponentItem : UserControl
    {
        public TeamsOpponentItem()
        {
        ...
        public void ShowPlaceholder(TeamsOpponentsViewModel item)
        {
            _item = item;
        ...
        private TeamsOpponentsViewModel _item;
    }
}
