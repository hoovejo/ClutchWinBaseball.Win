...
namespace ClutchWinBaseball.ItemViews
{
    ...
    /// </summary>
    public sealed partial class PlayersBatterItem : UserControl
    {
        public PlayersBatterItem()
        {
        ...
        public void ShowPlaceholder(PlayersBattersViewModel item)
        {
            _item = item;
        ...
        private PlayersBattersViewModel _item;
    }
}