...
{
    public sealed partial class PlayersPitcherItem : UserControl
    {
        public PlayersPitcherItem()
        {
        ...
        public void ShowPlaceholder(PlayersPitchersViewModel item)
        {
            _item = item;
        ...
        private PlayersPitchersViewModel _item;
    }
}
