...
{
    public sealed partial class PlayersYearItem : UserControl
    {
        public PlayersYearItem()
        {
        ...
        public void ShowPlaceholder(PlayersYearsViewModel item)
        {
            _item = item;
        ...
        private PlayersYearsViewModel _item;
    }
}