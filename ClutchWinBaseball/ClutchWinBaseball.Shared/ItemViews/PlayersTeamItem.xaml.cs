...
namespace ClutchWinBaseball.ItemViews
{
    ...
    /// </summary>
    public sealed partial class PlayersTeamItem : UserControl
    {
        public PlayersTeamItem()
        {
        ...
        public void ShowPlaceholder(PlayersTeamsViewModel item)
        {
            _item = item;
        ...
        private PlayersTeamsViewModel _item;
    }
}