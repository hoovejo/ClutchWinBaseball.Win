...
{
    public sealed partial class PlayersDrillDown : Page
    {
        ...
        public PlayersDrillDown()
        {
            ...
            (semanticZoom.ZoomedOutView as ListViewBase).ItemsSource = cvsPlayerDrillDownItems.View.CollectionGroups;
            (semanticZoomSmall.ZoomedOutView as ListViewBase).ItemsSource = cvsPlayerDrillDownItems.View.CollectionGroups;
        }
        ...
        {
            PlayersDrillDownItem iv = args.ItemContainer.ContentTemplateRoot as PlayersDrillDownItem;
            ...
            {
                iv.ShowPlaceholder(args.Item as PlayersDrillDownViewModel);
